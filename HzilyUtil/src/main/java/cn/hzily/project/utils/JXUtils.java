package cn.hzily.project.utils;
...
public class JXUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        jsonObject.put("mch_id", "1577820001");
        jsonObject.put("nonce_str", "a4420870df9d4be3aae9f43ac956aad6");
        jsonObject.put("sign", "a4420870df9d4be3aae9f43ac956aad6");
        JSONObject xmlJson = new JSONObject();
        xmlJson.put("xml", jsonObject);
        System.out.println(JXUtils.jsonToXml(xmlJson));
    }
}
